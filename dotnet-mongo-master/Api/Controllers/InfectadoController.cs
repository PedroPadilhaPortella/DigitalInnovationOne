...
namespace Api.Controllers
{
    ...
    public class InfectadoController : ControllerBase
    {
        ...
        [HttpPut]
        public IActionResult AtualizarInfectados([FromBody] InfectadoDto dto)
        {
        ...
        public IActionResult DeletarInfectados(DateTime dataNascimento)
        {
            _infectadosCollection.DeleteOne(Builders<Infectado>.Filter
                .Where(i => i.DataNascimento == dataNascimento));
